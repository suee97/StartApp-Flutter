...
class Common {
  ...
  static String faq_a1 = "A. 자치회비는 매학기 등록금 납부기간에 가상계좌를 통해 납부하실 수 있습니다. 고지서에 기재된 등록금에 11,000원을 추가한 금액을 입금하면 자동으로 자치회비 납부처리가 됩니다. 세부사항은 등록금 고지서를 통해 확인하실 수 있습니다. 또한 등록금 납부기간에 기재된 학생처나 총학생회 번호(02-970-7011)로 연락주시면 자세한 설명을 들으실 수 있습니다.";
  static String faq_q2 = "Q. 자치회비가 어디에 사용되는지 알고싶어요.";
  static String faq_a2 = "A. 총학생회 페이스북/인스타그램 위의 경로를 통해서 결산안을 확인하실 수 있습니다.";

  // 앱바 스타일
  static TextStyle startAppBarTextStyle = TextStyle(
  ...
  static String parseTime(String startTime, String endTime) {
    ...
    return " ${startTime.substring(5, 7)}/${startTime.substring(
