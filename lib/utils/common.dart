...
class Common {
  ...
  static String faq_q9 = "Q : 사무국은 어떤 일을 하나요?";
  static String faq_a9 = "A : 사무국은 대외적으로 학생자치기구 및 특별기구에 자치회비를 배분하는 일을 맡고 있으며, 대내적으로는 학생회실 운영 및 상시사업 진행에 필요한 비품을 구입하고 그에 따른 재정업무를 처리합니다. 투명하고 공정한 업무 수행을 위해 자치회비 예·결산안을 '전체학생대표자대회'에서 인준받으며 관련 자료는 매월 활동 보고 및 재정감사 결과를 통해 확인할 수 있습니다.";

  static String faq_q10 = "Q : 대외협력은 어떤 일을 하나요?";
  static String faq_a10 = "A : 대외협력국은 교외 즉, 학교 밖의 다른 단체와 협력을 통해서 대학문제에 대한 해결을 논의하는데 중점을 가지고 활동합니다. 다양한 연합체와 회의를 통하여 사안에 대해 논의하고 진행합니다.";

  static String faq_q11 = "Q : 미디어IT국은 어떤 일을 하나요?";
  static String faq_a11 = "A : 미디어IT국은 우리대학 학생사회의 장기적인 발전을 위해, 총학생회의 사업 전반에 대한 문서•영상 기록물을 제작하는 부서입니다. 효과적인 아카이빙을 위한 기틀을 다지고, 총학생회 유튜브 채널을 운영하는 등 각종 미디어와 IT관련 업무를 처리하고 있습니다.";
