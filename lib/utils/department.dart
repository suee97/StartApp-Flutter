...
class DepartmentST {
  ...
  static Set<String> iceDepartments = {
    '전기정보공학과',
    '전자IT미디어공학과',
    '컴퓨터공학과',
    '스마트ICT융합공학과'
  };
  static Set<String> natureDepartments = {
    '화공생명공학과',
    '환경공학과',
    '식품공학과',
    '정밀화학과',
  ...
  static Set<String> andDepartments = {
    '디자인학과(산업디자인전공)',
    '디자인학과(시각디자인전공)',
    '도예학과',
    '금속공예디자인학과',
  ...
  static Set<String> sgcDepartments = {
    '산업정보시스템전공',
    'ITM전공',
    'MSDE학과',
    '경영학전공',
  ...
  static Set<String> disciplinaryDepartments = {
    '융합공학부(융합기계공학전공)',
    '융합공학부(건설환경융합전공)',
    '융합사회학부(헬스피트니스전공)',
    '융합사회학부(문화예술전공)',
