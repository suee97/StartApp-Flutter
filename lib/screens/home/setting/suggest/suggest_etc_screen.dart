...
class SuggestEtcScreen extends StatefulWidget {
  const SuggestEtcScreen({Key? key}) : super(key: key);

  @override
  State<SuggestEtcScreen> createState() => _SuggestEtcScreenState();
}

class _SuggestEtcScreenState extends State<SuggestEtcScreen> {
  ...
  Future<StatusCode> postSuggest() async {
    ...
    FormData _formData = FormData.fromMap(
        {"title": title, "content": content, "category": "ETC", "file": _file});
