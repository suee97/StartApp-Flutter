...
class SuggestErrorScreen extends StatefulWidget {
  const SuggestErrorScreen({Key? key}) : super(key: key);

  @override
  State<SuggestErrorScreen> createState() => _SuggestErrorScreenState();
}

class _SuggestErrorScreenState extends State<SuggestErrorScreen> {
