...
class EventScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<EventNotifier>(builder: (context, eventNotifier, child) {
      ...
      var eventListDummy = eventNotifier.getDummyEventList();
      /// Dummy Dummy Dummy Dummy Dummy Dummy Dummy Dummy Dummy Dummy Dummy

      eventNotifier.fetchEventList();
      var eventList = eventNotifier.getEventList();
          ...
          child: Column(children: <Widget>[
            ...
            Expanded(
              child: ListView.builder(
                itemCount: eventListDummy.length,
                itemBuilder: (context, index) {
                  return EventTile(
                      event: eventListDummy[index],
                      onPressed: () => {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
